...
-- General behavior -- Add vertical line at 80 char
...
o.relativenumber = false -- Relative numbers for easy navigation
...
opt.shiftwidth = 4 -- Indent size for << and >> -- Add vertical line at 80 char
